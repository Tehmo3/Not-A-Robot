 ...
 * @type {number}
 */
var DEFAULT_MAX_OVERLAP_RATIO = 1;
 ...
 * @type {number}
 */
var DEFAULT_MAX_OVERLAP_TOTAL = 150000;
...
var Text = function () {
  ...
  _createClass(Text, [{
    ...
    value: function testSentenceOutput(words) {
      ...
      var maxOverlapRatio = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_MAX_OVERLAP_RATIO;
      var maxOverlapTotal = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_MAX_OVERLAP_TOTAL;
    ...
    value: function makeSentence(startFrom) {
      ...
      var _opts$tries = opts.tries,
          tries = _opts$tries === undefined ? DEFAULT_TRIES : _opts$tries,
          maxOverlapRatio = opts.maxOverlapRatio,
          maxOverlapTotal = opts.maxOverlapTotal,
